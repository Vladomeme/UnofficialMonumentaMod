...
public class ChestCountOverlay extends HudElement {
	...
	protected void render(DrawContext context, float tickDelta) {
		...
		context.fill(0, 0, WIDTH, HEIGHT, MinecraftClient.getInstance().options.getTextBackgroundColor(UnofficialMonumentaModClient.options.overlay_opacity));

		context.drawItem(CHEST, 4, (HEIGHT - 16) / 2);
