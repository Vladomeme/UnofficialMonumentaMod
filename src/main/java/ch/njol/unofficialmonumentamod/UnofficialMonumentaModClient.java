...
public class UnofficialMonumentaModClient implements ClientModInitializer {
	...
	public static final TextureSpoofer spoofer = new TextureSpoofer();

	public static final DiscordPresence discordRPC = DiscordPresence.INSTANCE;

	public static final EffectOverlay effectOverlay = new EffectOverlay();

	public static final AbilityHandler abilityHandler = new AbilityHandler();

	public static final KeyBinding toggleCalculatorKeyBinding = new KeyBinding("unofficial-monumenta-mod.keybinds.toggleCalculator", GLFW.GLFW_KEY_K, "unofficial-monumenta-mod.keybinds.category");
